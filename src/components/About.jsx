   ...
   */}
      <div className='mt-2 flex flex-col sm:flex-row sm:gap-10 justify-center items-center gap-10'>
        ...
        >
          ...
          I'm an enthusiastic and fast-learning M.Tech student in Computer Science, actively seeking opportunities to apply my skills in Software Development, cloud computing, or DevOps through an hands-on.
          <br/>
          I’ve built a solid foundation in programming with C++, Python, and JavaScript, and I’m passionate about developing scalable APIs, automating workflows using CI/CD pipelines, and exploring tools like Docker, Kubernetes, and AWS.
        </motion.p>
